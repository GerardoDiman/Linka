...
app.get('/notion/databases', async (req, res) => {
  try {
    ...
    console.log('✅ [DEV] Respuesta exitosa con', enrichedDatabases.length, 'bases de datos');
    res.json(result);
...
// Iniciar servidor
app.listen(PORT, () => {
  console.log(`🚀 [DEV] Servidor simple corriendo en http://localhost:${PORT}`);
  console.log(`📊 [DEV] Frontend debería conectarse a: http://localhost:${PORT}/notion`);
  console.log(`🧪 [DEV] Prueba la conexión en: http://localhost:${PORT}/test`);
